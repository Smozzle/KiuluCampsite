    ...
    <div class="dashboard-container">
      ...
      <div class="admin-form">
        <form action="" method="POST">
          ...
          <input type="text" id="userName" name="userName" value="<?= htmlspecialchars($userName) ?>" style="border: 1px solid;" required><br><br>

          <label for="userName">User Email:</label>
          <input type="text" id="userEmail" name="userEmail" value="<?= htmlspecialchars($userEmail) ?>" style="border: 1px solid;" required><br><br>

          <label for="userPwd">New Password:</label>
          <input type="password" id="userPwd" name="userPwd" style="border: 1px solid;"><br><br>

          <label for="confirmPwd">Confirm New Password:</label>
          <input type="password" id="confirmPwd" name="confirmPwd" style="border: 1px solid;"><br><br>

          <label for="userRoles">User Role:</label>
          <select id="userRoles" name="userRoles" style="border: 1px solid;" required>
          ...
          <input type="date" id="regDate" name="regDate" value="<?= htmlspecialchars($regDate) ?>" style="border: 1px solid;" required><br><br>
